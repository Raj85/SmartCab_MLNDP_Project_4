...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        if self.learning == False:
            ...
            if self.epsilon > random.random():
                ...
                maxStateAction = [key for key, values  in self.Q[state].items() if values == maxQVal]
                action = random.choice (maxStateAction)
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            # Q[s, a] ← (1 − α)Q[s, a] + α[R(s, a, s0) + γ max-a Q[s0, a0]]
